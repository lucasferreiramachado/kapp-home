...
val frameworkLibraryName    = "KAppHome" // execute gradle clean after changed it
val libraryArtifact         = "kapp-home"
val libraryPackage          = "${libraryNamespace}.kapp.home"
...
android {
    namespace = "io.github.lucasferreiramachado.kapp.home.core"
