...
val frameworkLibraryName    = "KAppHomeCompose" // execute gradle clean after changed it
val libraryArtifact         = "kapp-home-compose"
val libraryPackage          = "${libraryNamespace}.kapp.home.compose"
val githubRepoName          = "kapp-home"
...
//            implementation("io.github.lucasferreiramachado:kapp-home:0.1.0")
        }
...
android {
    namespace = "com.lucasferreiramachado.kapp.home.compose"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.lucasferreiramachado.kapp.home.compose"
...
compose.desktop {
    application {
        mainClass = "com.lucasferreiramachado.kapp.home.compose.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "com.lucasferreiramachado.kapp.home.compose"
